...
#define iconv_version _libiconv_version
#endif
...
#endif
extern LIBICONV_DLL_EXPORTED iconv_t iconv_open(const char *tocode,
                                                const char *fromcode);
...
#endif
// extern LIBICONV_DLL_EXPORTED size_t iconv (iconv_t cd, @ICONV_CONST@ char* *
...
extern LIBICONV_DLL_EXPORTED int iconv_open_into(const char *tocode,
                                                 const char *fromcode,
                                                 iconv_allocation_t *resultp);

/* Control of attributes. */
#define iconvctl libiconvctl
extern LIBICONV_DLL_EXPORTED int iconvctl(iconv_t cd, int request,
                                          void *argument);
...
iconvlist(int (*do_one)(unsigned int namescount, const char *const *names,
                        void *data),
          void *data);

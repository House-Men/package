...
extern "C" {
        ...
        struct BDFaceMouthMaskList {
            int num;          // 数据个数，通常为N x 3， N为输入的人脸个数（与关键点列表的num一致）
            float* scores;    // 数据地址. [未佩戴口罩概率， 佩戴口罩概率， 其他面部遮挡概率] x N，按关键点列表输入的人脸顺序依次排列
        };
         ...
         * @param[in]   const strut BDFaceLandmarkList*     landmark_list       人脸关键点列表数据地址
